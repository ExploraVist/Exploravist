        ...
        <Navbar/>
          <main className='contact'>
            <section className='contact_hero'>
              ...
              <h2 className='contact_paragraph'>We’re always looking for passionate individuals to support our mission of developing affordable accessibility devices. Right now, we’re seeking new funding opportunities and expanding our network of Blind and Visually Impaired contacts.</h2>
